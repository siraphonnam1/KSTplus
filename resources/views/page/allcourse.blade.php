    ...
    <div class="py-12">
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-3 px-4 flex justify-between items-center">
                <p class="fs-2 fw-bold">All Courses</p>
                <div class="basis-1/4">
                    <div class="relative w-full">
                        <input type="search" id="search-courses" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search courses">
