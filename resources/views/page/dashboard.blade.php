                ...
                'excel',
                {
                    ...
                    customize: function(doc) {
                        ...
                        doc.content.splice(2, 0, {
                            ...
                            fontSize: 12,
                            alignment: 'center',
                            margin: [0, 0, 0, 15] // Additional space below the subtitle before the table starts
                        });
                        ...
                        var cm = 28.35;
                        doc.pageMargins = [1.5 * cm, 1 * cm, 1.5 * cm, 1.5 * cm]; // Or any other margin you prefer
