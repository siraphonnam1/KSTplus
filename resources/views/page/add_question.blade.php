            ...
            <form action="{{ route('quiz.quest.store', ['id' => $id]) }}" method="post">
                ...
                <div class="card px-5 py-4">
                    ...
                    <div id="default-tab-content">
                        <div class="flex hidden p-2 ps-5 rounded-lg bg-gray-50 " id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <div class="p-4 flex justify-center">
                                <button type="button" style="background-color: rgb(0, 153, 0)" id="addAns" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-2 "><i class="bi bi-plus-lg"></i> Add</button>
                            </div>
                        </div>
                    ...
                    <div class="mt-20">
                        ...
                        <button type="button" style="background-color: rgb(255, 103, 103)" class="transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-300 focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ">
                            Cancel
                        </button>
                    </div>
                </div>
